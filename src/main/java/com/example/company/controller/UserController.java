...
public class UserController {
    ...
    public DataResult login(@RequestBody @Valid User vo, HttpServletRequest request) {
        //判断验证码
    ...
    public DataResult register(@RequestBody @Valid User vo) {
    ...
    public DataResult updateUserInfo(@RequestBody User vo) {
    ...
    @ApiOperation(value = "更新用户信息接口")
    @LogAnnotation(title = "用户管理", action = "更新用户信息")
    public DataResult updateUserInfoById(@RequestBody User vo) {
    ...
    public DataResult pageInfo(@RequestBody User vo) {
    ...
    public DataResult addUser(@RequestBody @Valid User vo) {
