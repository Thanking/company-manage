...
import com.example.company.common.config.FileUploadProperties;
import com.example.company.common.exception.BusinessException;
import com.example.company.common.utils.DataResult;
import com.example.company.common.utils.DateUtils;
import com.example.company.entity.Files;
import com.example.company.mapper.FilesMapper;
...
public class FilesServiceImpl extends ServiceImpl<FilesMapper, Files> implements FilesService {
    ...
    public DataResult saveFile(MultipartFile file) {
        ...
        try {
            ...
            //保存文件记录
            Files sysFilesEntity = new Files();
    ...
    public void removeByIdsAndFiles(List<String> ids) {
        List<Files> list = this.listByIds(ids);
        list.forEach(entity -> {
            //如果之前的文件存在，删除
